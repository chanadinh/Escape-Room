...
export default function QR1Page() {
  const url = typeof window !== 'undefined' ? window.location.href : `${process.env.NEXT_PUBLIC_BASE_URL || 'https://escape-room-lemon.vercel.app'}/qr_1`;
  ...
  return (
    <div className="min-h-screen bg-black text-green-400 font-mono flex items-center justify-center p-6">
      <div className="bg-gray-900 border-2 border-green-500 rounded-lg p-8 text-center">
        <div className="text-2xl font-bold mb-4">QR CODE #1</div>
